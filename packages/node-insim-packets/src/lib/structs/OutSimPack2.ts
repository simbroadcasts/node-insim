...
import { OutSimOptions } from '../enums/OutSimOptions.js';
import { OutSimInputs } from './OutSimInputs.js';
import { OutSimMain } from './OutSimMain.js';
import { OutSimWheel } from './OutSimWheel.js';
...
export class OutSimPack2 extends Struct {
  ...
  public override getValidPropertyNames(): string[] {
